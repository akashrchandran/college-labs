...
**1.** Fork [this](https://github.com/akashrchandran/college-labs) repository.

**2.** Clone your forked copy of the project.

```
git clone https://github.com/<your_name>/college-labs.git
```
...
```
git remote add upstream https://github.com/akashrchandran/college-labs.git
```
...
**15** Voila! You have made a PR to college-labs. Sit back patiently and relax while your PR is reviewed.
